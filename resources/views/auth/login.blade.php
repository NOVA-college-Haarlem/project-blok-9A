<x-app-layout>
    ...
    <div class="container mx-auto">
        ...
        <form method="POST" action="{{ route('login') }}" class="bg-white p-8 rounded-lg shadow-md">
            @csrf

            <!-- Email Address -->
            <div>
                <x-input-label for="email" :value="__('Email')" />
                <x-text-input id="email" class="block mt-1 w-full p-2 rounded-md" type="email" name="email"
            ...
            <div class="mt-4">
                ...
                <x-text-input id="password" class="block mt-1 w-full p-2 rounded-md" type="password" name="password"
